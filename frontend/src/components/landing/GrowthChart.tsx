  ...
  return (
    <div className="relative">
      <svg viewBox="0 0 1000 360" className="w-full" fill="none">
        <line x1="0" y1="120" x2="1000" y2="120" stroke="#3a382e" strokeDasharray="4 6" />
        <line x1="0" y1="240" x2="1000" y2="240" stroke="#3a382e" strokeDasharray="4 6" />
        <path
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <line x1="0" y1="356" x2="1000" y2="356" stroke="#5a5848" strokeWidth="1.5" />
      </svg>

      {callouts.map((c) => (
        <span
          key={c.label}
          className="absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent px-3 py-1.5 text-[13px] font-semibold text-base-50 shadow-lg"
